The Nextion: How-To-Build tutorial in this section is written using the LST ('Old") editor. The new editor (v. 0.56 and up) has more powerfull features which are not used by this tutorial.
