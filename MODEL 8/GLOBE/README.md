REMARK 1: In this folder are 'OLD' (LST editor; all filenames starting with Model 8...) and 'NEW' Editor files; both for Basic and Enhanced screens; both Editors are (for free) at www.nextion.tech available.
